Component({
    properties: {
        ...
        _img_top:{
            type:Number,
            value: wx.getSystemInfoSync().windowHeight / 2, //图片上边距
        },
        /**     
         * 图片路径
         */
    ...
    methods: {
        ...
        upload() {
             ...
             */
            getImg(getCallback) {
                let {scale,angle,_img_top,_img_left} = this.data
            
                 angle = angle<0 ? Math.abs(angle) : (angle - (angle * 2));
                this._draw(() => {
            ...
            imageLoad(e) {
                const {windowHeight} = this.data.info;
